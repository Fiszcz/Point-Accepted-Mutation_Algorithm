...
export const EntrySequencesTable: React.FC<EntrySequencesTableProps> = props => {
    ...
    const handleChangeNewSequence = (event: React.ChangeEvent<HTMLInputElement>) => {
        ...
        if ((inputValue.match(letters) && inputValue.length < 14) || inputValue === '') setNewSequence(inputValue.toUpperCase());
    };

    const handleDetectEnter = (event: React.KeyboardEvent) => {
        if (event.keyCode === 13) addSequence();
    };
    ...
    return (
        <div className={css({ width: '100%' })}>
            <Typography weight={'bold'}>Tablica sekwencji</Typography>
            <Table size={'small'} className={tableStyle}>
                ...
                <TableHead>
                    <TableRow>
                        <TableCell className={tableHeadCellStyle}>
                        ...
                        <TableCell className={tableHeadCellStyle}>
                            <Typography weight={'bold'}>Akcja</Typography>
                        </TableCell>
                    </TableRow>
                </TableHead>
                <TableBody>
                        ...
                        <TableRow>
                            ...
                            <TableCell className={tableCellStyle}>
                                <TextField
                                    value={newSequence}
                                    className={textFieldStyle}
                                    onChange={handleChangeNewSequence}
